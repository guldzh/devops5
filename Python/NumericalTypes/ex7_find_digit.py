...
fourthNum=four_digit_num%10
ThirdNum=(four_digit_num//10)%10
SecondNum=(four_digit_num//10//10)%10
FirstNum=(four_digit_num//10//10//10)%10

print(f"Four digit number is -{FirstNum,SecondNum,fourthNum,ThirdNum}")
print(FirstNum,SecondNum,fourthNum,ThirdNum)
